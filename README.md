...
* Install Django 1.4
* Run `django-admin.py startproject --template https://github.com/jacobrpg/django-h5bp-template/zipball/master --extension py,md,gitignore,dist,html yourprojectname` specifying your project name.
